...
from basicsr.models.archs.akdt_arch import AKDT
...
parser = argparse.ArgumentParser(description='Gasussian Grayscale Denoising using AKDT')
...
if args.model_type == 'blind':
    yaml_file = 'Options/GaussianGrayDenoising_AKDT.yml'
else:
    yaml_file = f'Options/GaussianGrayDenoising_AKDTSigma{args.sigmas}.yml'
import yaml
