...
parser = argparse.ArgumentParser(description='Gaussian Color Denoising using AKDT')
...
if args.model_type == 'blind':
    yaml_file = 'Options/GaussianColorDenoising_AKDT.yml'
else:
    yaml_file = f'Options/GaussianColorDenoising_AKDTSigma{args.sigmas}.yml'
import yaml
